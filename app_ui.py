...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image.setMinimumSize(QSize(501, 421))
        self.image.setMaximumSize(QSize(501, 421))
        self.image.setPixmap(QPixmap(u"C:/Users/marvi/OneDrive/Im\u00e1genes/WhatsApp Images/image.jpg"))
